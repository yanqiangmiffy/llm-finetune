...
class PeftModelForSequenceClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example::
        ...
        >>> from transformers import AutoModelForSequenceClassification >>> from bakcup.peft import
...
class PeftModelForCausalLM(PeftModel):
    ...
    Example::
        ...
        >>> from transformers import AutoModelForCausalLM >>> from bakcup.peft import PeftModelForCausalLM, get_peft_config
        >>> config = {
...
class PeftModelForSeq2SeqLM(PeftModel):
    ...
    Example::
        ...
        >>> from transformers import AutoModelForSeq2SeqLM >>> from bakcup.peft import PeftModelForSeq2SeqLM, get_peft_config
        >>> config = {
